...
var BlockEmbed = /*#__PURE__*/function (_Parchment$Embed) {
  ...
  _createClass(BlockEmbed, [{
    ...
    value: function format(name, value) {
      var attribute = parchment__WEBPACK_IMPORTED_MODULE_2___default().query(name, (parchment__WEBPACK_IMPORTED_MODULE_2___default().Scope.BLOCK_ATTRIBUTE));
    ...
    value: function insertAt(index, value, def) {
      if (typeof value === 'string' && value.endsWith('\n')) {
        var block = parchment__WEBPACK_IMPORTED_MODULE_2___default().create(Block.blotName);
  ...
  return BlockEmbed;
}((parchment__WEBPACK_IMPORTED_MODULE_2___default().Embed));

BlockEmbed.scope = (parchment__WEBPACK_IMPORTED_MODULE_2___default().Scope.BLOCK_BLOT); // It is important for cursor behavior BlockEmbeds use tags that are block level elements

var Block = /*#__PURE__*/function (_Parchment$Block) {
  ...
  function Block(domNode) {
    ...
    _this = _super2.call(this, domNode);
    _this.cache = {};
    return _this;
  }
  ...
  _createClass(Block, [{
    ...
    value: function delta() {
      if (this.cache.delta == null) {
        this.cache.delta = this.descendants((parchment__WEBPACK_IMPORTED_MODULE_2___default().Leaf)).reduce(function (delta, leaf) {
          if (leaf.length() === 0) {
            return delta;
          } else {
    ...
    key: "insertAt",
    value: function insertAt(index, value, def) {
      if (def != null) return _get(_getPrototypeOf(Block.prototype), "insertAt", this).call(this, index, value, def);
  ...
  return Block;
}((parchment__WEBPACK_IMPORTED_MODULE_2___default().Block));
...
var Break = /*#__PURE__*/function (_Parchment$Embed) {
  ...
  _createClass(Break, [{
    ...
    value: function insertInto(parent, ref) {
      if (parent.children.length === 0) {
        _get(_getPrototypeOf(Break.prototype), "insertInto", this).call(this, parent, ref);
      } else {
        this.remove();
      }
    }
  ...
  return Break;
}((parchment__WEBPACK_IMPORTED_MODULE_0___default().Embed));
...
var Container = /*#__PURE__*/function (_Parchment$Container) {
...
}((parchment__WEBPACK_IMPORTED_MODULE_0___default().Container));
...
var Cursor = /*#__PURE__*/function (_Parchment$Embed) {
  ...
  _createClass(Cursor, [{
    ...
    value: function format(name, value) {
      if (this._length !== 0) {
        return _get(_getPrototypeOf(Cursor.prototype), "format", this).call(this, name, value);
      }
...
var Embed = /*#__PURE__*/function (_Parchment$Embed) {
...
var Inline = /*#__PURE__*/function (_Parchment$Inline) {
  ...
  return Inline;
}((parchment__WEBPACK_IMPORTED_MODULE_1___default().Inline));

Inline.allowedChildren = [Inline, (parchment__WEBPACK_IMPORTED_MODULE_1___default().Embed), _text__WEBPACK_IMPORTED_MODULE_0__["default"]]; // Lower index means deeper in the DOM tree, since not found (-1) is for embeds
...
var Scroll = /*#__PURE__*/function (_Parchment$Scroll) {
  ...
  _createClass(Scroll, [{
    ...
    value: function insertAt(index, value, def) {
      ...
      if (index >= this.length()) {
        if (def == null || parchment__WEBPACK_IMPORTED_MODULE_0___default().query(value, (parchment__WEBPACK_IMPORTED_MODULE_0___default().Scope.BLOCK)) == null) {
          var blot = parchment__WEBPACK_IMPORTED_MODULE_0___default().create(this.statics.defaultChild);
          ...
          var embed = parchment__WEBPACK_IMPORTED_MODULE_0___default().create(value, def);
    ...
    value: function insertBefore(blot, ref) {
      if (blot.statics.scope === (parchment__WEBPACK_IMPORTED_MODULE_0___default().Scope.INLINE_BLOT)) {
        var wrapper = parchment__WEBPACK_IMPORTED_MODULE_0___default().create(this.statics.defaultChild);
  ...
  return Scroll;
}((parchment__WEBPACK_IMPORTED_MODULE_0___default().Scroll));
...
var TextBlot = /*#__PURE__*/function (_Parchment$Text) {
  _inherits(TextBlot, _Parchment$Text);

  var _super = _createSuper(TextBlot);
  ...
  return _createClass(TextBlot);
}((parchment__WEBPACK_IMPORTED_MODULE_0___default().Text));
  ...
  _createClass(Editor, [{
      ...
      delta.reduce(function (index, op) {
        ...
        if (op.insert != null) {
          if (typeof op.insert === 'string') {
            ...
            var formats = extend__WEBPACK_IMPORTED_MODULE_9___default()({}, (0,_blots_block__WEBPACK_IMPORTED_MODULE_5__.bubbleFormats)(line));

            if (line instanceof _blots_block__WEBPACK_IMPORTED_MODULE_5__["default"]) {
              var _line$descendant = line.descendant((parchment__WEBPACK_IMPORTED_MODULE_2___default().Leaf), offset),
    ...
    value: function getFormat(index) {
      ...
      var formatsArr = [lines, leaves].map(function (blots) {
        ...
        var formats = (0,_blots_block__WEBPACK_IMPORTED_MODULE_5__.bubbleFormats)(blots.shift());
    ...
    value: function insertEmbed(index, embed, value) {
      ...
      return this.update(new (quill_delta__WEBPACK_IMPORTED_MODULE_0___default())().retain(index).insert(_defineProperty({}, embed, value)));
    }
  }, {
    key: "insertText",
    ...
    value: function removeFormat(index, length) {
      ...
      var _this$scroll$line3 = this.scroll.line(index + length),
          ...
          offset = _this$scroll$line4[1];

      var suffixLength = 0,
          suffix = new (quill_delta__WEBPACK_IMPORTED_MODULE_0___default())();
      ...
      var diff = contents.diff(new (quill_delta__WEBPACK_IMPORTED_MODULE_0___default())().insert(text).concat(suffix));
      var delta = new (quill_delta__WEBPACK_IMPORTED_MODULE_0___default())().retain(index).concat(diff);
    ...
    value: function update(change) {
      ...
      if (mutations.length === 1 && mutations[0].type === 'characterData' && mutations[0].target.data.match(ASCII) && parchment__WEBPACK_IMPORTED_MODULE_2___default().find(mutations[0].target)) {
        // Optimization for character changes
        var textBlot = parchment__WEBPACK_IMPORTED_MODULE_2___default().find(mutations[0].target);
        var formats = (0,_blots_block__WEBPACK_IMPORTED_MODULE_5__.bubbleFormats)(textBlot);
        var index = textBlot.offset(this.scroll);
        var oldValue = mutations[0].oldValue.replace(_blots_cursor__WEBPACK_IMPORTED_MODULE_4__["default"].CONTENTS, '');
        var oldText = new (quill_delta__WEBPACK_IMPORTED_MODULE_0___default())().insert(oldValue);
        var newText = new (quill_delta__WEBPACK_IMPORTED_MODULE_0___default())().insert(textBlot.value());
        var diffDelta = new (quill_delta__WEBPACK_IMPORTED_MODULE_0___default())().retain(index).concat(oldText.diff(newText, cursorIndex));
...
function normalizeDelta(delta) {
  return delta.reduce(function (delta, op) {
    if (op.insert === 1) {
      var attributes = clone__WEBPACK_IMPORTED_MODULE_7___default()(op.attributes);
...
var debug = (0,_logger__WEBPACK_IMPORTED_MODULE_1__["default"])('quill:events');
...
var Emitter = /*#__PURE__*/function (_EventEmitter) {
  ...
  _createClass(Emitter, [{
    ...
    value: function emit() {
      ...
      _get(_getPrototypeOf(Emitter.prototype), "emit", this).apply(this, arguments);
    }
  }, {
    key: "handleDOM",
...
var debug = (0,_logger__WEBPACK_IMPORTED_MODULE_8__["default"])('quill');
...
var Quill = /*#__PURE__*/function () {
  function Quill(container) {
    ...
    this.theme.init();
    this.emitter.on(_emitter__WEBPACK_IMPORTED_MODULE_3__["default"].events.EDITOR_CHANGE, function (type) {
    ...
    this.emitter.on(_emitter__WEBPACK_IMPORTED_MODULE_3__["default"].events.SCROLL_UPDATE, function (source, mutations) {
    ...
    var contents = this.clipboard.convert("<div class='ql-editor' style=\"white-space: normal;\">".concat(html, "<p><br></p></div>"));
  ...
  _createClass(Quill, [{
    ...
    value: function format(name, value) {
      ...
      return modify.call(this, function () {
        ...
        var change = new (quill_delta__WEBPACK_IMPORTED_MODULE_1___default())();
        ...
        _this3.setSelection(range, _emitter__WEBPACK_IMPORTED_MODULE_3__["default"].sources.SILENT);
    ...
    value: function setContents(delta) {
      ...
      var source = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _emitter__WEBPACK_IMPORTED_MODULE_3__["default"].sources.API;
      return modify.call(this, function () {
        delta = new (quill_delta__WEBPACK_IMPORTED_MODULE_1___default())(delta);

        var length = _this9.getLength();

        var deleted = _this9.editor.deleteText(0, length);
        ...
        if (lastOp != null && typeof lastOp.insert === 'string' && lastOp.insert[lastOp.insert.length - 1] === '\n') {
          _this9.editor.deleteText(_this9.getLength() - 1, 1);
    ...
    value: function setText(text) {
      var source = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _emitter__WEBPACK_IMPORTED_MODULE_3__["default"].sources.API;
      var delta = new (quill_delta__WEBPACK_IMPORTED_MODULE_1___default())().insert(text);
...
Quill.sources = _emitter__WEBPACK_IMPORTED_MODULE_3__["default"].sources; // eslint-disable-next-line no-undef
...
function expandConfig(container, userConfig) {
  ...
  var themeConfig = extend__WEBPACK_IMPORTED_MODULE_7___default()(true, {}, userConfig.theme.DEFAULTS);
  ...
  userConfig = extend__WEBPACK_IMPORTED_MODULE_7___default()(true, {}, Quill.DEFAULTS, {
...
function modify(modifier, source, index, shift) {
  ...
  if (change.length() > 0) {
    ...
    var args = [_emitter__WEBPACK_IMPORTED_MODULE_3__["default"].events.TEXT_CHANGE, change, oldDelta, source];
...
var debug = (0,_logger__WEBPACK_IMPORTED_MODULE_4__["default"])('quill:selection');
...
var Selection = /*#__PURE__*/function () {
  function Selection(scroll, emitter) {
    ...
    this.cursor = parchment__WEBPACK_IMPORTED_MODULE_0___default().create('cursor', this); // savedRange is last non-null range
    ...
    this.emitter.on(_emitter__WEBPACK_IMPORTED_MODULE_3__["default"].events.EDITOR_CHANGE, function (type, delta) {
  ...
  _createClass(Selection, [{
    ...
    value: function format(_format, value) {
      ...
      if (nativeRange == null || !nativeRange["native"].collapsed || parchment__WEBPACK_IMPORTED_MODULE_0___default().query(_format, (parchment__WEBPACK_IMPORTED_MODULE_0___default().Scope.BLOCK))) return;

      if (nativeRange.start.node !== this.cursor.textNode) {
        var blot = parchment__WEBPACK_IMPORTED_MODULE_0___default().find(nativeRange.start.node, false);
    ...
    value: function getBounds(index) {
      ...
      var node,
          _this$scroll$leaf = this.scroll.leaf(index),
    ...
    value: function normalizedToRange(range) {
      ...
      var indexes = positions.map(function (position) {
        ...
        var blot = parchment__WEBPACK_IMPORTED_MODULE_0___default().find(node, true);
    ...
    value: function update() {
      ...
      if (!deep_equal__WEBPACK_IMPORTED_MODULE_2___default()(oldRange, this.lastRange)) {
        ...
        var args = [_emitter__WEBPACK_IMPORTED_MODULE_3__["default"].events.SELECTION_CHANGE, clone__WEBPACK_IMPORTED_MODULE_1___default()(this.lastRange), clone__WEBPACK_IMPORTED_MODULE_1___default()(oldRange), source];
...
var AlignAttribute = new (parchment__WEBPACK_IMPORTED_MODULE_0___default().Attributor.Attribute)('align', 'align', config);
var AlignClass = new (parchment__WEBPACK_IMPORTED_MODULE_0___default().Attributor.Class)('align', 'ql-align', config);
var AlignStyle = new (parchment__WEBPACK_IMPORTED_MODULE_0___default().Attributor.Style)('align', 'text-align', config);
...
var BackgroundClass = new (parchment__WEBPACK_IMPORTED_MODULE_0___default().Attributor.Class)('background', 'ql-bg', {
...
var CodeBlock = /*#__PURE__*/function (_Block) {
  ...
  _createClass(CodeBlock, [{
    ...
    value: function format(name, value) {
      ...
      var _this$descendant = this.descendant(_blots_text__WEBPACK_IMPORTED_MODULE_4__["default"], this.length() - 1),
          _this$descendant2 = _slicedToArray(_this$descendant, 1),
          text = _this$descendant2[0];

      if (text != null) {
        text.deleteAt(text.length() - 1, 1);
      }

      _get(_getPrototypeOf(CodeBlock.prototype), "format", this).call(this, name, value);
    }
  }, {
    key: "formatAt",
    value: function formatAt(index, length, name, value) {
      ...
      if (parchment__WEBPACK_IMPORTED_MODULE_1___default().query(name, (parchment__WEBPACK_IMPORTED_MODULE_1___default().Scope.BLOCK)) == null || name === this.statics.blotName && value === this.statics.formats(this.domNode)) {
        return;
      }
    ...
    value: function insertAt(index, value, def) {
      ...
      var _this$descendant3 = this.descendant(_blots_text__WEBPACK_IMPORTED_MODULE_4__["default"], index),
          _this$descendant4 = _slicedToArray(_this$descendant3, 2),
          text = _this$descendant4[0],
          offset = _this$descendant4[1];
    ...
    value: function optimize(context) {
      ...
      _get(_getPrototypeOf(CodeBlock.prototype), "optimize", this).call(this, context);
    ...
    value: function replace(target) {
      _get(_getPrototypeOf(CodeBlock.prototype), "replace", this).call(this, target);

      [].slice.call(this.domNode.querySelectorAll('*')).forEach(function (node) {
        var blot = parchment__WEBPACK_IMPORTED_MODULE_1___default().find(node);
    ...
    value: function create(value) {
      var domNode = _get(_getPrototypeOf(CodeBlock), "create", this).call(this, value);
  ...
  return CodeBlock;
}(_blots_block__WEBPACK_IMPORTED_MODULE_2__["default"]);
...
}((parchment__WEBPACK_IMPORTED_MODULE_0___default().Attributor.Style));

var ColorClass = new (parchment__WEBPACK_IMPORTED_MODULE_0___default().Attributor.Class)('color', 'ql-color', {
  scope: (parchment__WEBPACK_IMPORTED_MODULE_0___default().Scope.INLINE)
});
...
var DirectionAttribute = new (parchment__WEBPACK_IMPORTED_MODULE_0___default().Attributor.Attribute)('direction', 'dir', config);
var DirectionClass = new (parchment__WEBPACK_IMPORTED_MODULE_0___default().Attributor.Class)('direction', 'ql-direction', config);
var DirectionStyle = new (parchment__WEBPACK_IMPORTED_MODULE_0___default().Attributor.Style)('direction', 'direction', config);
...
var FontClass = new (parchment__WEBPACK_IMPORTED_MODULE_0___default().Attributor.Class)('font', 'ql-font', config);

var FontStyleAttributor = /*#__PURE__*/function (_Parchment$Attributor) {
...
var Image = /*#__PURE__*/function (_Parchment$Embed) {
  ...
  _createClass(Image, [{
    ...
    value: function sanitize(url) {
      return (0,_formats_link__WEBPACK_IMPORTED_MODULE_1__.sanitize)(url, ['http', 'https', 'data']) ? url : '//:0';
    }
  }, {
    key: "value",
    value: function value(domNode) {
...
var Link = /*#__PURE__*/function (_Inline) {
  ...
  _createClass(Link, [{
    key: "format",
    value: function format(name, value) {
      if (name !== this.statics.blotName || !value) return _get(_getPrototypeOf(Link.prototype), "format", this).call(this, name, value);
  ...
  _createClass(ListItem, [{
    ...
    value: function format(name, value) {
      if (name === List.blotName && !value) {
        this.replaceWith(parchment__WEBPACK_IMPORTED_MODULE_0___default().create(this.statics.scope));
      } else {
    ...
    value: function remove() {
      if (this.prev == null && this.next == null) {
        ...
        _get(_getPrototypeOf(ListItem.prototype), "remove", this).call(this);
      }
    }
  }, {
    key: "replaceWith",
    value: function replaceWith(name, value) {
      ...
      if (name === this.parent.statics.blotName) {
        ...
        this.parent.unwrap();
        return _get(_getPrototypeOf(ListItem.prototype), "replaceWith", this).call(this, name, value);
      }
    }
  }], [{
    key: "formats",
    value: function formats(domNode) {
      return domNode.tagName === this.tagName ? undefined : _get(_getPrototypeOf(ListItem), "formats", this).call(this, domNode);
    }
  }]);

  return ListItem;
}(_blots_block__WEBPACK_IMPORTED_MODULE_1__["default"]);
...
var List = /*#__PURE__*/function (_Container) {
  ...
  function List(domNode) {
    ...
    var listEventHandler = function listEventHandler(e) {
      ...
      var blot = parchment__WEBPACK_IMPORTED_MODULE_0___default().find(e.target);
  ...
  _createClass(List, [{
    ...
    value: function replace(target) {
      if (target.statics.blotName !== this.statics.blotName) {
        var item = parchment__WEBPACK_IMPORTED_MODULE_0___default().create(this.statics.defaultChild);
  ...
  return List;
}(_blots_container__WEBPACK_IMPORTED_MODULE_2__["default"]);

List.blotName = 'list';
List.scope = (parchment__WEBPACK_IMPORTED_MODULE_0___default().Scope.BLOCK_BLOT);
List.tagName = ['OL', 'UL'];
...
var SizeClass = new (parchment__WEBPACK_IMPORTED_MODULE_0___default().Attributor.Class)('size', 'ql-size', {
  scope: (parchment__WEBPACK_IMPORTED_MODULE_0___default().Scope.INLINE),
  whitelist: ['small', 'large', 'huge']
});
var SizeStyle = new (parchment__WEBPACK_IMPORTED_MODULE_0___default().Attributor.Style)('size', 'font-size', {
  scope: (parchment__WEBPACK_IMPORTED_MODULE_0___default().Scope.INLINE),
...
var Strike = /*#__PURE__*/function (_Inline) {
...
var debug = (0,_core_logger__WEBPACK_IMPORTED_MODULE_4__["default"])('quill:clipboard');
...
var Clipboard = /*#__PURE__*/function (_Module) {
  ...
  function Clipboard(quill, options) {
    ...
    _this.quill.root.addEventListener('paste', _this.onPaste.bind(_assertThisInitialized(_this)));
  ...
  _createClass(Clipboard, [{
    ...
    value: function convert(html) {
      ...
      if (formats[_formats_code__WEBPACK_IMPORTED_MODULE_8__["default"].blotName]) {
        ...
        this.container.innerHTML = '';
        return new (quill_delta__WEBPACK_IMPORTED_MODULE_1___default())().insert(text, _defineProperty({}, _formats_code__WEBPACK_IMPORTED_MODULE_8__["default"].blotName, formats[_formats_code__WEBPACK_IMPORTED_MODULE_8__["default"].blotName]));
      }

      var _this$prepareMatching = this.prepareMatching(),
    ...
    value: function onPaste(e) {
      ...
      var delta = new (quill_delta__WEBPACK_IMPORTED_MODULE_1___default())().retain(range.index);
      ...
      setTimeout(function () {
        ...
        _this2.quill.updateContents(delta, _core_quill__WEBPACK_IMPORTED_MODULE_3__["default"].sources.USER); // range.length contributes to delta.length()


        _this2.quill.setSelection(delta.length() - range.length, _core_quill__WEBPACK_IMPORTED_MODULE_3__["default"].sources.SILENT);
  ...
  if (_typeof(format) === 'object') {
    ...
    return delta.reduce(function (delta, op) {
      if (op.attributes && op.attributes[format]) {
        ...
        return delta.insert(op.insert, extend__WEBPACK_IMPORTED_MODULE_0___default()({}, _defineProperty({}, format, value), op.attributes));
      }
...
function matchAttributor(node, delta) {
  var attributes = parchment__WEBPACK_IMPORTED_MODULE_2___default().Attributor.Attribute.keys(node);
  var classes = parchment__WEBPACK_IMPORTED_MODULE_2___default().Attributor.Class.keys(node);
  var styles = parchment__WEBPACK_IMPORTED_MODULE_2___default().Attributor.Style.keys(node);
  var formats = {};
  attributes.concat(classes).concat(styles).forEach(function (name) {
    var attr = parchment__WEBPACK_IMPORTED_MODULE_2___default().query(name, (parchment__WEBPACK_IMPORTED_MODULE_2___default().Scope.ATTRIBUTE));
...
function matchBlot(node, delta) {
  var match = parchment__WEBPACK_IMPORTED_MODULE_2___default().query(node);
...
function matchIndent(node, delta) {
  ...
  return delta.compose(new (quill_delta__WEBPACK_IMPORTED_MODULE_1___default())().retain(delta.length() - 1).retain(1, {
    indent: indent
  }));
}
...
var debug = (0,_core_logger__WEBPACK_IMPORTED_MODULE_7__["default"])('quill:keyboard');
...
var Keyboard = /*#__PURE__*/function (_Module) {
  ...
  _createClass(Keyboard, [{
    ...
    value: function listen() {
      ...
      this.quill.root.addEventListener('keydown', function (evt) {
        ...
        var _this2$quill$getLine = _this2.quill.getLine(range.index),
            _this2$quill$getLine2 = _slicedToArray(_this2$quill$getLine, 2),
            line = _this2$quill$getLine2[0],
            offset = _this2$quill$getLine2[1];

        var _this2$quill$getLeaf = _this2.quill.getLeaf(range.index),
            _this2$quill$getLeaf2 = _slicedToArray(_this2$quill$getLeaf, 2),
            leafStart = _this2$quill$getLeaf2[0],
            offsetStart = _this2$quill$getLeaf2[1];
        ...
        var prefixText = leafStart instanceof (parchment__WEBPACK_IMPORTED_MODULE_5___default().Text) ? leafStart.value().slice(0, offsetStart) : '';
        var suffixText = leafEnd instanceof (parchment__WEBPACK_IMPORTED_MODULE_5___default().Text) ? leafEnd.value().slice(offsetEnd) : '';
        var curContext = {
  ...
  return Keyboard;
}(_core_module__WEBPACK_IMPORTED_MODULE_8__["default"]);
  ...
  bindings: {
    ...
    'tab': {
      ...
      handler: function handler(range) {
        ...
        var delta = new (quill_delta__WEBPACK_IMPORTED_MODULE_3___default())().retain(range.index)["delete"](range.length).insert('\t');
    ...
    'checklist enter': {
      ...
      handler: function handler(range) {
        ...
        var formats = extend__WEBPACK_IMPORTED_MODULE_2___default()({}, line.formats(), {
          list: 'checked'
        });
        var delta = new (quill_delta__WEBPACK_IMPORTED_MODULE_3___default())().retain(range.index).insert('\n', formats).retain(line.length() - offset - 1).retain(1, {
          list: 'unchecked'
        });
        this.quill.updateContents(delta, _core_quill__WEBPACK_IMPORTED_MODULE_6__["default"].sources.USER);
        this.quill.setSelection(range.index + 1, _core_quill__WEBPACK_IMPORTED_MODULE_6__["default"].sources.SILENT);
    ...
    'list autofill': {
      ...
      handler: function handler(range, context) {
        ...
        this.quill.history.cutoff();
        var delta = new (quill_delta__WEBPACK_IMPORTED_MODULE_3___default())().retain(range.index - offset)["delete"](length + 1).retain(line.length() - 2 - offset).retain(1, {
          list: value
        });
        this.quill.updateContents(delta, _core_quill__WEBPACK_IMPORTED_MODULE_6__["default"].sources.USER);
        this.quill.history.cutoff();
    ...
    'code exit': {
      ...
      handler: function handler(range) {
        ...
        var delta = new (quill_delta__WEBPACK_IMPORTED_MODULE_3___default())().retain(range.index + line.length() - offset - 2).retain(1, {
          'code-block': null
        })["delete"](1);
        this.quill.updateContents(delta, _core_quill__WEBPACK_IMPORTED_MODULE_6__["default"].sources.USER);
      }
...
function handleBackspace(range, context) {
  ...
  if (context.offset === 0) {
    var _this$quill$getLine11 = this.quill.getLine(range.index - 1),
        _this$quill$getLine12 = _slicedToArray(_this$quill$getLine11, 1),
...
function handleDelete(range, context) {
  ...
  var _this$quill$getLine13 = this.quill.getLine(range.index),
      _this$quill$getLine14 = _slicedToArray(_this$quill$getLine13, 1),
      line = _this$quill$getLine14[0];

  if (context.offset >= line.length() - 1) {
    var _this$quill$getLine15 = this.quill.getLine(range.index + 1),
        _this$quill$getLine16 = _slicedToArray(_this$quill$getLine15, 1),
...
function handleEnter(range, context) {
  ...
  Object.keys(context.format).forEach(function (name) {
    ...
    _this3.quill.format(name, context.format[name], _core_quill__WEBPACK_IMPORTED_MODULE_6__["default"].sources.USER);
  });
}
...
function makeCodeBlockHandler(indent) {
  return {
    ...
    handler: function handler(range) {
      var CodeBlock = parchment__WEBPACK_IMPORTED_MODULE_5___default().query('code-block');
      var index = range.index,
          length = range.length;

      var _this$quill$scroll$de = this.quill.scroll.descendant(CodeBlock, index),
          _this$quill$scroll$de2 = _slicedToArray(_this$quill$scroll$de, 2),
          block = _this$quill$scroll$de2[0],
...
var debug = (0,_core_logger__WEBPACK_IMPORTED_MODULE_3__["default"])('quill:toolbar');
    ...
    value: function attach(input) {
      ...
      input.addEventListener(eventName, function (e) {
        ...
        if (_this2.handlers[format] != null) {
          ...
          value = prompt("Enter ".concat(format));
          if (!value) return;

          _this2.quill.updateContents(new (quill_delta__WEBPACK_IMPORTED_MODULE_0___default())().retain(range.index)["delete"](range.length).insert(_defineProperty({}, format, value)), _core_quill__WEBPACK_IMPORTED_MODULE_2__["default"].sources.USER);
        } else {
...
var BaseTheme = /*#__PURE__*/function (_Theme) {
  ...
  return BaseTheme;
}(_core_theme__WEBPACK_IMPORTED_MODULE_4__["default"]);
            ...
            fileInput.addEventListener('change', function () {
              if (fileInput.files != null && fileInput.files[0] != null) {
                ...
                reader.onload = function (e) {
                  ...
                  _this3.quill.updateContents(new (quill_delta__WEBPACK_IMPORTED_MODULE_1___default())().retain(range.index)["delete"](range.length).insert({
                    image: e.target.result
                  }), _core_emitter__WEBPACK_IMPORTED_MODULE_2__["default"].sources.USER);

                  _this3.quill.setSelection(range.index + 1, _core_emitter__WEBPACK_IMPORTED_MODULE_2__["default"].sources.SILENT);
...
var BaseTooltip = /*#__PURE__*/function (_Tooltip) {
  ...
  var _super2 = _createSuper(BaseTooltip);
  ...
  function BaseTooltip(quill, boundsContainer) {
    ...
    _this4 = _super2.call(this, quill, boundsContainer);
  ...
  return BaseTooltip;
}(_ui_tooltip__WEBPACK_IMPORTED_MODULE_8__["default"]);
...
var SnowTheme = /*#__PURE__*/function (_BaseTheme) {
  ...
  var _super = _createSuper(SnowTheme);
...
var SnowTooltip = /*#__PURE__*/function (_BaseTooltip) {
  ...
  var _super2 = _createSuper(SnowTooltip);
  ...
  function SnowTooltip(quill, bounds) {
    ...
    _this2 = _super2.call(this, quill, bounds);
...
var IconPicker = /*#__PURE__*/function (_Picker) {
  ...
  _createClass(IconPicker, [{
    key: "selectItem",
    value: function selectItem(item, trigger) {
      _get(_getPrototypeOf(IconPicker.prototype), "selectItem", this).call(this, item, trigger);
...
var Picker = /*#__PURE__*/function () {
  ...
  _createClass(Picker, [{
    ...
    value: function buildLabel() {
      ...
      label.innerHTML = (_assets_icons_dropdown_svg__WEBPACK_IMPORTED_MODULE_1___default());
      label.tabIndex = '0';
...
/* harmony import */ var quill_formats_underline__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! quill/formats/underline */ "./node_modules/quill/formats/underline.js");
/* harmony import */ var quill_formats_header__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! quill/formats/header */ "./node_modules/quill/formats/header.js");
/* harmony import */ var quill_formats_font__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! quill/formats/font */ "./node_modules/quill/formats/font.js");
...
/* harmony import */ var quill_formats_image__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! quill/formats/image */ "./node_modules/quill/formats/image.js");
...
/* harmony import */ var quill_formats_blockquote__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! quill/formats/blockquote */ "./node_modules/quill/formats/blockquote.js");
/* harmony import */ var quill_formats_strike__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! quill/formats/strike */ "./node_modules/quill/formats/strike.js");
/* harmony import */ var quill_formats_code__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! quill/formats/code */ "./node_modules/quill/formats/code.js");
...
quill_core__WEBPACK_IMPORTED_MODULE_0__["default"].register({
  ...
  'formats/underline': quill_formats_underline__WEBPACK_IMPORTED_MODULE_5__["default"],
  'formats/strike': quill_formats_strike__WEBPACK_IMPORTED_MODULE_12__["default"],
  'formats/header': quill_formats_header__WEBPACK_IMPORTED_MODULE_6__["default"],
  'formats/font-style': quill_formats_font__WEBPACK_IMPORTED_MODULE_7__.FontStyle,
  'formats/font-class': quill_formats_font__WEBPACK_IMPORTED_MODULE_7__.FontClass,
  'formats/align-attribute': quill_formats_align__WEBPACK_IMPORTED_MODULE_8__.AlignAttribute,
  'formats/align-class': quill_formats_align__WEBPACK_IMPORTED_MODULE_8__.AlignClass,
  'formats/align-style': quill_formats_align__WEBPACK_IMPORTED_MODULE_8__.AlignStyle,
  'formats/image': quill_formats_image__WEBPACK_IMPORTED_MODULE_9__["default"],
  ...
  'formats/blockquote': quill_formats_blockquote__WEBPACK_IMPORTED_MODULE_11__["default"],
  'formats/code-block': quill_formats_code__WEBPACK_IMPORTED_MODULE_13__["default"],
  'formats/code': quill_formats_code__WEBPACK_IMPORTED_MODULE_13__.Code
});
var toolbarOptions = [[{
  'header': ['1', '2', '3', false]
}], [{
  'font': []
}], ['bold', 'italic', 'underline', 'strike', 'link'], ['blockquote', 'code', 'image'], [{
  'align': []
}], [{
  'list': 'ordered'
}, {
...
var quill = new quill_core__WEBPACK_IMPORTED_MODULE_0__["default"]('#body', options);
...
// Module
var code = "<svg viewbox=\"0 0 18 18\"> <path class=\"ql-fill\" d=\"M14,16H4a1,1,0,0,1,0-2H14A1,1,0,0,1,14,16Z\"/> <path class=\"ql-fill\" d=\"M14,4H4A1,1,0,0,1,4,2H14A1,1,0,0,1,14,4Z\"/> <rect class=\"ql-fill\" x=\"3\" y=\"6\" width=\"12\" height=\"6\" rx=\"1\" ry=\"1\"/> </svg>";
// Exports
module.exports = code;
...
// Module
var code = "<svg viewbox=\"0 0 18 18\"> <path class=\"ql-fill\" d=\"M13,16H5a1,1,0,0,1,0-2h8A1,1,0,0,1,13,16Z\"/> <path class=\"ql-fill\" d=\"M13,4H5A1,1,0,0,1,5,2h8A1,1,0,0,1,13,4Z\"/> <rect class=\"ql-fill\" x=\"2\" y=\"6\" width=\"14\" height=\"6\" rx=\"1\" ry=\"1\"/> </svg>";
// Exports
module.exports = code;
...
// Module
var code = "<svg viewbox=\"0 0 18 18\"> <path class=\"ql-fill\" d=\"M15,8H13a1,1,0,0,1,0-2h2A1,1,0,0,1,15,8Z\"/> <path class=\"ql-fill\" d=\"M15,12H13a1,1,0,0,1,0-2h2A1,1,0,0,1,15,12Z\"/> <path class=\"ql-fill\" d=\"M15,16H5a1,1,0,0,1,0-2H15A1,1,0,0,1,15,16Z\"/> <path class=\"ql-fill\" d=\"M15,4H5A1,1,0,0,1,5,2H15A1,1,0,0,1,15,4Z\"/> <rect class=\"ql-fill\" x=\"2\" y=\"6\" width=\"8\" height=\"6\" rx=\"1\" ry=\"1\"/> </svg>";
// Exports
module.exports = code;
...
// Module
var code = "<svg viewbox=\"0 0 18 18\"> <path class=\"ql-fill\" d=\"M5,8H3A1,1,0,0,1,3,6H5A1,1,0,0,1,5,8Z\"/> <path class=\"ql-fill\" d=\"M5,12H3a1,1,0,0,1,0-2H5A1,1,0,0,1,5,12Z\"/> <path class=\"ql-fill\" d=\"M13,16H3a1,1,0,0,1,0-2H13A1,1,0,0,1,13,16Z\"/> <path class=\"ql-fill\" d=\"M13,4H3A1,1,0,0,1,3,2H13A1,1,0,0,1,13,4Z\"/> <rect class=\"ql-fill\" x=\"8\" y=\"6\" width=\"8\" height=\"6\" rx=\"1\" ry=\"1\" transform=\"translate(24 18) rotate(-180)\"/> </svg>";
// Exports
module.exports = code;
...
throw new Error("Module build failed (from ./node_modules/mini-css-extract-plugin/dist/loader.js):\nModuleBuildError: Module build failed (from ./node_modules/postcss-loader/dist/cjs.js):\nError: Failed to find '~quill/dist/quill.core.css'\n  in [\n    /Users/nicola/Code/scapegrace/resources/css\n  ]\n    at /Users/nicola/Code/scapegrace/node_modules/postcss-import/lib/resolve-id.js:35:13\n    at async LazyResult.runAsync (/Users/nicola/Code/scapegrace/node_modules/postcss/lib/lazy-result.js:396:11)\n    at async Object.loader (/Users/nicola/Code/scapegrace/node_modules/postcss-loader/dist/index.js:97:14)\n    at processResult (/Users/nicola/Code/scapegrace/node_modules/webpack/lib/NormalModule.js:753:19)\n    at /Users/nicola/Code/scapegrace/node_modules/webpack/lib/NormalModule.js:855:5\n    at /Users/nicola/Code/scapegrace/node_modules/loader-runner/lib/LoaderRunner.js:399:11\n    at /Users/nicola/Code/scapegrace/node_modules/loader-runner/lib/LoaderRunner.js:251:18\n    at context.callback (/Users/nicola/Code/scapegrace/node_modules/loader-runner/lib/LoaderRunner.js:124:13)\n    at Object.loader (/Users/nicola/Code/scapegrace/node_modules/postcss-loader/dist/index.js:142:7)");
